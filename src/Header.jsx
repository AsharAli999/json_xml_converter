      ...
      <div class="pb-6 sm:pb-8 lg:pb-12">
        <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
          <header class="mb-8 flex items-center justify-between border-b py-4 md:mb-12 md:py-8 xl:mb-16">
            ...
            {/* <!-- buttons - start --> */}
            <a href="https://gradientoo-app.vercel.app" class="hidden rounded-lg bg-gray-200 px-8 py-3 text-center text-sm font-semibold text-gray-500 outline-none ring-indigo-300 transition duration-100 hover:bg-gray-300 focus-visible:ring active:text-gray-700 md:text-base lg:inline-block">See other apps</a>
          ...
          <section class="flex flex-col items-center">
            <div class="flex max-w-xl flex-col items-center pb-16 pt-8 text-center lg:pb-48 lg:pt-32">
              <p class="mb-4 font-semibold text-indigo-500 md:mb-6 md:text-lg xl:text-xl">Easy data formatter</p>

              <h1 class="mb-8 text-4xl font-bold text-black sm:text-5xl md:mb-12 md:text-6xl"><span className='bg-gradient-to-t from-custom-gradient via-custom-gradient-alt to-custom-gradient-alt-2 bg-clip-text text-transparent'>XML to JSON</span> and <span class="bg-gradient-to-r from-custom-gradient via-custom-gradient-alt to-custom-gradient-alt-2 bg-clip-text text-transparent"> JSON to XML</span> </h1>
            ...
            <div class="flex items-center justify-center gap-4 lg:justify-start">
              <span class="text-sm font-semibold uppercase tracking-widest text-slate-900 sm:text-base">Social</span>
              <span class="h-px w-12 text-slate-900"></span>

              <div class="flex gap-4">
                <a href="#" target="_blank" class="text-slate-900 transition duration-100 hover:text-slate-900 active:text-slate-900">
